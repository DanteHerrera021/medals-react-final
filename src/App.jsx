...
function App() {
  ...
  const apiEndpoint =
    "https://medals-backend-auth-deghhnabg5eebufv.northcentralus-01.azurewebsites.net/jwtapi/country";
  const hubEndpoint =
    "https://medals-backend-auth-deghhnabg5eebufv.northcentralus-01.azurewebsites.net/medalsHub";
  const userEndpoint =
    "https://jwt-roles-c2hbe6hjc8djbnhm.northcentralus-01.azurewebsites.net/api/user/login";
